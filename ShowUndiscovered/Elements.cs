...
public class Elements {
    ...
    public Elements(bool baseGameOnlyIn) {
        ...
        this.elements.Add(new ElementInfo(SimHashes.Amber, true, false, GameTags.Organics));
        ...
        this.elements.Add(new ElementInfo(SimHashes.Cobaltite, true, false, GameTags.Metal)); // cobalt ore
        ...
        this.elements.Add(new ElementInfo(SimHashes.CrushedRock, false, true, GameTags.BuildableProcessed)); // crushed rock can be mined on Arid Planet in base game
        this.elements.Add(new ElementInfo(SimHashes.Cuprite, false, false, GameTags.Metal)); // copper ore
        ...
        this.elements.Add(new ElementInfo(SimHashes.DirtyIce, false, false, GameTags.Liquifiable)); // polluted ice
        ...
        this.elements.Add(new ElementInfo(SimHashes.FoolsGold, false, true, GameTags.Metal)); // Pyrite can be mined on Gilded Asteroid in base game
        ...
        this.elements.Add(new ElementInfo(SimHashes.HardPolypropylene, false, false, GameTags.ManufacturedMaterial)); // plastium
        ...
        this.elements.Add(new ElementInfo(SimHashes.Iridium, true, false, GameTags.RefinedMetal));
        ...
        this.elements.Add(new ElementInfo(SimHashes.Katairite, false, false, GameTags.Other)); // abyssalite
        ...
        this.elements.Add(new ElementInfo(SimHashes.MilkFat, false, false, GameTags.ConsumableOre)); // brackwax
        this.elements.Add(new ElementInfo(SimHashes.MilkIce, false, false, GameTags.Liquifiable)); // frozen brackene
        this.elements.Add(new ElementInfo(SimHashes.Mud, true, false, GameTags.Organics));
        this.elements.Add(new ElementInfo(SimHashes.Nickel, true, false, GameTags.RefinedMetal));
        this.elements.Add(new ElementInfo(SimHashes.NickelOre, true, false, GameTags.Metal));
        ...
        this.elements.Add(new ElementInfo(SimHashes.OxyRock, false, false, GameTags.ConsumableOre)); // oxylite
        this.elements.Add(new ElementInfo(SimHashes.Peat, true, false, GameTags.ConsumableOre));
        this.elements.Add(new ElementInfo(SimHashes.Phosphorite, false, false, GameTags.Agriculture));
        this.elements.Add(new ElementInfo(SimHashes.Phosphorus, false, false, GameTags.ConsumableOre)); // refined phorphorus
        this.elements.Add(new ElementInfo(SimHashes.Polypropylene, false, false, GameTags.ManufacturedMaterial)); // plastic
        ...
        this.elements.Add(new ElementInfo(SimHashes.Shale, true, false, GameTags.BuildableRaw));
        ...
        this.elements.Add(new ElementInfo(SimHashes.SuperInsulator, false, false, GameTags.ManufacturedMaterial)); // insulation
        this.elements.Add(new ElementInfo(SimHashes.TempConductorSolid, false, false, GameTags.ManufacturedMaterial)); // thermium
        this.elements.Add(new ElementInfo(SimHashes.ToxicMud, true, false, GameTags.Organics)); // polluted mud
        this.elements.Add(new ElementInfo(SimHashes.ToxicSand, false, false, GameTags.Organics)); // polluted dirt
        ...
        this.elements.Add(new ElementInfo(SimHashes.DirtyWater, false, false, GameTags.Liquid)); // polluted water
        ...
        this.elements.Add(new ElementInfo(SimHashes.Milk, false, false, GameTags.Liquid)); // brackene
        ...
        this.elements.Add(new ElementInfo(SimHashes.MoltenIridium, true, false, GameTags.RefinedMetal));
        ...
        this.elements.Add(new ElementInfo(SimHashes.MoltenNickel, true, false, GameTags.RefinedMetal));
        ...
        this.elements.Add(new ElementInfo(SimHashes.ContaminatedOxygen, false, false, GameTags.Breathable)); // polluted oxygen
        ...
        this.elements.Add(new ElementInfo(SimHashes.IridiumGas, true, false, GameTags.Unbreathable));
        ...
        this.elements.Add(new ElementInfo(SimHashes.NickelGas, true, false, GameTags.Unbreathable));
